function drawParallelCoordinates(archivo)
{
...
var line = d3.svg.line(),
  ...
  background,
  foreground;
d3.select("#ParallelCoordinates").remove();
var svg = d3.select("#DParallelCoordinates").append("svg")
...
d3.csv(archivo, function(error, colegios) {
